...
args = forest.options_gru_constraint_update([0])   # Parameters setting
...
args.log_file_dir = current_directory + '/log_file_const' # log save path
...
if __name__ == "__main__":
    ...
    data = forest.Kettle(args, model.defs.batch_size, model.defs.augmentations,
                         setup=setup)  # model.defs.augmentations: None.
    ...
    time_path = current_directory + '/log_file_const/timestamps.mat'
